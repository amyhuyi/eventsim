...
${OBJECTDIR}/genran/extreal.o: genran/extreal.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/extreal.o genran/extreal.cpp

${OBJECTDIR}/genran/format.o: genran/format.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/format.o genran/format.cpp

${OBJECTDIR}/genran/geturng.o: genran/geturng.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/geturng.o genran/geturng.cpp

${OBJECTDIR}/genran/myexcept.o: genran/myexcept.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/myexcept.o genran/myexcept.cpp

${OBJECTDIR}/genran/newran1.o: genran/newran1.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/newran1.o genran/newran1.cpp

${OBJECTDIR}/genran/newran2.o: genran/newran2.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/newran2.o genran/newran2.cpp

${OBJECTDIR}/genran/nr_ex.o: genran/nr_ex.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/nr_ex.o genran/nr_ex.cpp

${OBJECTDIR}/genran/simpstr.o: genran/simpstr.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/simpstr.o genran/simpstr.cpp

${OBJECTDIR}/genran/str.o: genran/str.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/str.o genran/str.cpp

${OBJECTDIR}/genran/test_lg.o: genran/test_lg.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/test_lg.o genran/test_lg.cpp

${OBJECTDIR}/genran/test_out.o: genran/test_out.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/test_out.o genran/test_out.cpp

${OBJECTDIR}/genran/tryrand.o: genran/tryrand.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/tryrand.o genran/tryrand.cpp

${OBJECTDIR}/genran/tryrand1.o: genran/tryrand1.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/tryrand1.o genran/tryrand1.cpp

${OBJECTDIR}/genran/tryrand2.o: genran/tryrand2.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/tryrand2.o genran/tryrand2.cpp

${OBJECTDIR}/genran/tryrand3.o: genran/tryrand3.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/tryrand3.o genran/tryrand3.cpp

${OBJECTDIR}/genran/tryrand4.o: genran/tryrand4.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/tryrand4.o genran/tryrand4.cpp

${OBJECTDIR}/genran/tryrand5.o: genran/tryrand5.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/tryrand5.o genran/tryrand5.cpp

${OBJECTDIR}/genran/tryrand6.o: genran/tryrand6.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/tryrand6.o genran/tryrand6.cpp

${OBJECTDIR}/genran/tryurng.o: genran/tryurng.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/tryurng.o genran/tryurng.cpp

${OBJECTDIR}/genran/tryurng1.o: genran/tryurng1.cpp 
	${MKDIR} -p ${OBJECTDIR}/genran
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/genran/tryurng1.o genran/tryurng1.cpp
